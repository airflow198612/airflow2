...
def webserver(args):
    ...
    if args.debug:
        ...
        restart_workers(gunicorn_master_proc, args.workers)

def restart_workers(gunicorn_master_proc, num_workers_expected):
    """
    Restart webserver workers
    """
    ...
    def get_num_ready_workers_running(gunicorn_master_proc):
        ...
        ready_workers = [
            ...
            if "[ready]" in proc.cmdline()[0]
            ]
        return len(ready_workers)

    def start_refresh(gunicorn_master_pid):
        ...
        for _ in range(batch_size):
            gunicorn_master_pid.send_signal(signal.SIGTTIN)
            excess += 1
    ...
    while True:
        ...
        # Start a new worker by asking gunicorn to increase number of workers
            ...
            time.sleep(10)
            if len(
                    psutil.Process(gunicorn_master_proc).children()
