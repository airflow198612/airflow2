...
class LaunchSpecification(object):
    ...
    """
    def __init__(self, spot_specification=None):
        """
        LaunchSpecification - a model defined in Swagger
    ...
    def spot_specification(self):
        """
        Gets the spot_specification of this LaunchSpecification.
        Determines the defined duration and provisioning timeout behavior

        :return: The spot_specification of this LaunchSpecification.
        :rtype: SpotSpecification
        """
    ...
    def spot_specification(self, spot_specification):
        """
        Sets the spot_specification of this LaunchSpecification.
        Determines the defined duration and provisioning timeout behavior

        :param spot_specification: The spot_specification of this LaunchSpecification.
